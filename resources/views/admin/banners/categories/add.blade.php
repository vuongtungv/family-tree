    ...
    <div class="portlet light portlet-fit portlet-form bordered">
        <div class="portlet-title">
            <div class="caption">
                ...
                <span class="caption-subject font-red sbold uppercase">Thêm mới: Danh mục Banners</span>
            </div>
            <div class="actions">
        ...
        <div class="portlet-body">
            ...
            @endif
            <form action="{{ route('post_admin_add_banners_category') }}" id="add-category" method="POST" role="form" enctype="multipart/form-data">
                {{ csrf_field()}}
                <div class="form-body">
